...
def generate_project_tree(start_path: str, ignore_patterns: list) -> str:
    """生成项目目录结构
    ...
    def traverse(current_path: Path, prefix: str = ""):
        """递归遍历目录"""
        items = []
        for item in current_path.iterdir():
            if not is_ignored(item, ignore_patterns):
                items.append(item)
...
class DirectoryStructureGenerator:
    ...
    def _generate_structure(self):
        ...
        tree = generate_project_tree(project_path, ignore_patterns)
